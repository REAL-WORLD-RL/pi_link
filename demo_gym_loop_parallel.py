...
class GymLoop:
    ...
    def panallel_step(self):
        ...
        # Debug: 检查 truncated 状态
        if np.any(truncated):
            print(f"[DEBUG] step {self.steps}: truncated={truncated}, terminated={terminated}")
...
def main() -> None:
    ...
    print(remote_env.observation_space)
    print(remote_env.action_space)
